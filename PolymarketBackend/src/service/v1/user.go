...
import (
	...
	"github.com/locey/x402_polymarket/PolymarketBase/errcode"
	"github.com/locey/x402_polymarket/PolymarketBase/stores/gdb/orderbookmodel/base"
	"github.com/google/uuid"
	"github.com/pkg/errors"

	"github.com/locey/x402_polymarket/PolymarketBackend/src/api/middleware"
...
func genLoginTemplate(nonce string) string {
	return fmt.Sprintf("Welcome to Polymarket!\nNonce:%s", nonce)
}
